...
word_dict = {
    ...
    'อาหาร'     :['เครื่องปรุง','วัตถุดิบ','ของหวาน','ของกิน','โภชนาการ','แฮม','เจ','กินเจ','มังสวิรัติ','กุ้ง','หอย','วัว','หมู','หมึก','สาหร่าย','เป็ด','ปลา','ปู','เนื้อ','สลัด','ข้าวต้ม','กะปิ','ปลาร้า','ขนมปัง','ซุป','น้ำพริก','ข้าวเหนียว','ลาบ','กะเพรา','ซาบะ'],
    'ทำอาหาร'   :['ปรุง','ทอด','แกง','ผัด','เจียว','ปิ้ง','เตา','ครัว','ครก','กระทะ','หม้อ'],
    'เครื่องปรุง'  :['เกลือ','เครื่องเทศ','ซอส','พริกไทย',],
    'วัตถุดิบ'     :['แป้ง','ส่วนผสม','เนย','กะทิ','ข้าวสาลี','ธัญพืช','เต้าเจี้ยว'],
    'ของหวาน'   :['ขนม','ครีม','เค้ก','ไอศกรีม','ช็อกโกแลต','น้ำผึ้ง',],

    'เครื่องดื่ม'   :['เครื่องดื่ม','กาแฟ','ชา','ชาเย็น','น้ำอัดลม','นำ้ผลไม้','ชานมไข่มุก','ไวน์','สุรา','ค็อกเทล','เบียร์','โซดา','เครื่องดื่มชูกำลัง','เก๊กฮวย'],
    ...
    'กล้วย'      :['กล้วยน้ำว้า','กล้วยไข่','กล้วยหอม'],
    'ส้ม'        :['ส้มเขียวหวาน','ส้มเช้ง'],
    ...
    'การศึกษา'   :['การศึกษา','มหาวิทยาลัย','เรียนต่อ','ทุนการศึกษา','รายวิชา','ภาคเรียน','ความรู้','แนะแนว','พลศึกษา','เรียนรู้','เรียน','ครุ','โรงเรียนประจำ','คอนแวนต์','วิชาเอก','อาชีวศึกษา','หลักสูตร','วิชาการ','วิทยาเขต','ปีการศึกษา','ข้อสอบ','ตำรา','ลูกเสือ','ครู','คะแนน','สอบ','โรงเรียน','นักเรียน','ศึกษาธิการ','อาจารย์','ลูกศิษย์','ชมรม','วิทยา','คณาจารย์','เล่าเรียน','วิชา','หน่วยกิต','มัธยมศึกษา','มัธยม','สหศึกษา','ประถม','อนุบาล','โรงเรียนสาธิต'],
    ...
    'หนังสือ'     :['หนังสือ','วรรณกรรม','นวนิยาย','นิยาย','วรรณคดี','นิทาน','สิ่งพิมพ์','โรงพิมพ์','พิมพ์หนังสือ','นิตยสาร','สำนักพิมพ์','บรรณาธิการ','หนังสือพิมพ์','วารสาร','สารานุกรม','นามปากกา','ห้องสมุด','หอสมุด',],
    ...
    'บันเทิง'     :['บันเทิง','นางแบบ','นางงาม','ถ่ายแบบ','ดารา','นักแสดง'],
    ...
    'เจ็บป่วย'    :['เจ็บป่วย','โรคประจำตัว','โรคติดต่อ',   'พยาธิ','คลื่นไส้','เสมหะ','ซึมเศร้า','ท้องเสีย','อัมพาต','ปวด','ชัก','แผล','ตุ่ม','เจ็บปวด','ตาบอด','หูหนวก','ตาเหล่','หวัด','ปวดร้าว','ตีบ','ปวดแสบปวดร้อน','เจ็บไข้','ไอ','เป็นลม','เจ็บท้อง','เจ็บ','เนื้อร้าย','เนื้องอก','ประสาทหลอน','มะเร็ง','โรคประสาท','วัณโรค','อาเจียน','ฝี','โรคจิต','เชื้อโรค','โรคจิตเภท','กาฬโรค','ดื้อยา','ตับแข็ง','เหา','งูสวัด','โรคสมอง','โรค','ติดเชื้อ','อักเสบ','ป่วย','พิการ','บกพร่อง','เรื้อรัง','แพลง','วาย','โปลิโอ','เมื่อย',],
    ...
    'ความงาม'   :['ความงาม','ศัลยกรรม','กระ','ผิวหนัง','เล็บ','ผิว','หน้าอก','อก','สิว','เครื่องสำอาง','น้ำหอม','งาม','สวย','หล่อ','งดงาม','เครื่องประดับ','สปา','แต่งหน้า',],
    
    'สุขภาพ'     :['สุขภาพ','สารอาหาร',   'สมุนไพร','ความเครียด','เครียด',],
    ...
    'การเงิน'    :['การเงิน','ธุรกิจ',   'เครดิต','พาณิชย์','ธนาคาร','กองทุน','ภาษี','ฐานะ','เงินกู้','โอน','บัญชี','ประมูล','ภาษีเงินได้','งก','งบ','คลัง','เงิน','รายได้','รายจ่าย','เงินออม','เงินเก็บ','คนรวย','รวย','ร่ำรวย','เศรษฐี','งบประมาณ','กู้ยืม','ลูกหนี้','ทุน','ดอกเบี้ย','มรดก','ทรัพย์สิน','หนี้สิน','ธนบัตร','เหรียญ','สตางค์','ดอลลาร์','เงินตรา','หุ้นส่วน','เงินสด',],
    ...
    'ครอบครัว'   :['ครอบครัว','แม่','มารดา','ตระกูล','สืบเชื้อสาย','สายเลือด','เชื้อสาย','แม่ผัว','สะใภ้','พ่อตา','พี่น้อง','ลูกพี่ลูกน้อง','ญาติ','ทวด','ทายาท','หลาน','ลุง','ยาย','บุญธรรม','บุตรบุญธรรม',],
    ...
    'บันเทิง'     :['บันเทิง','ภาพยนตร์','ละคร','ละครโทรทัศน์','ดารา','เวที',],
...
text_list =[ 'ท้องเสียมาสองวันติดแล้ว กินยาตัวไหนดี'
,'เครื่องซักผ้าเสีย ซักผ้าอยู่ดีๆ ก็หยุดไปเลย'
,'แม่เผลอซักผ้าขาวปนกับผ้าสี แก้ยังไงได้ไหมคะ?'
,'แม่ผัวน่ารำคาญมาก หาเรื่องบ่นเราได้ตลอดเลย ทำยังไงดีคะ'
, 'กลิ่นเต่าแฟนเหม็นมาก รับไม่ได้'
,'แม่นอนกรนดังมาก'
,'ฝนตกทุกวัน ผ้าไม่แห้ง'
,'หุงข้าวแฉะทุกทีเลย'
,'เหรียญ 5 บาทหายทำไงดี'
,'กดเงินตังไม่ออกต้องทำไง'
,'วิธีแก้ไฟรั่ว'
,'ใบดรอปขอที่ไหน'
,'อ.ไม่ยอมอ่านแชทมาหลายวันแล้ว'
,'มือถือแบตหมดเร็วมาก'
,'เช็คอาการโควิด'
,'มือถือแบตหมดเร็วมาก'
,'ทำบัตรปชช.หาย'
,'ทำ ATM หาย'
,'วิธีไปเปลี่ยนชื่อ นามสกุล'
,'วิธีอายัดบัญชีคนโกง'
,'งูเข้าบ้าน'
,'เหี้ยเข้าบ้าน'
,'วิธีรักษาสิว'
,'วิธีรักษารอยดำจากสิว'
,'ท้องเสียจากาการเป็นประจำเดือนแก้ยัง'
,'แฟนขี้งอนแก้ยังไง'
,'แฟนไม่แบ่งขนมให้'
,'วิธีเซ็นเอกสารราชการ'
,'ลง ubuntu แล้วกลับมาเป็น window ไม่ได้'
,'เรียนไม่ทันคนอื่น'
,'กินแล้วไม่อ้วน'
,'ตามงานน้องเป็นเดือนแต่น้องไม่ส่งงาน'
,'บ้านไฟไหม้ควรทำยังไงเพื่อให้มีชีวิตรอด'
,'เรียนไม่ทันคนอื่น'
,'กินแล้วไม่อ้วน'
,'ตามงานน้องเป็นเดือนแต่น้องไม่ส่งงาน'
,'คลิปเรียน 1 ชมแต่เรียนจริง 6 ชม'
,'ไม่กล้าฆ่าแมลงสาบ'
,'ครูตีเด็ก'
,'เพื่อนลอกการบ้าน'
,'ท้องเสียจนเป็นลม'
...
# text = 'กินผักผลไม้วันละ 1 มื้อ'
# text = 'เลี้ยงแมวเหมียวในบ้าน'
...
for text in text_list:
    ...
    for word in word_tokenize(text, engine="newmm"):
        new_tag = find_tag(word, word_dict)
        tag_list.extend(new_tag)

    tag_list = remove_duplicate(tag_list)
