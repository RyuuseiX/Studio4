...
def word_category():
    word_dict = {
        ...
        'อาหาร'     :['อาหาร','ทำอาหาร','เครื่องปรุง','วัตถุดิบ','ของหวาน',   'ของกิน','โภชนาการ','แฮม','เจ','กินเจ','มังสวิรัติ','กุ้ง','หอย','วัว','หมู','หมึก','สาหร่าย','เป็ด','ปลา','ปู','เนื้อ','สลัด','ข้าวต้ม','กะปิ','ปลาร้า','ขนมปัง','ซุป','น้ำพริก','ข้าวเหนียว','ลาบ','กะเพรา','ซาบะ','ไข่ไก่'],
        ...
        'การศึกษา'   :['การศึกษา','มหาวิทยาลัย','เรียนต่อ','ทุนการศึกษา','รายวิชา','ภาคเรียน','ความรู้','แนะแนว','พลศึกษา','เรียนรู้','เรียน','ครุ','โรงเรียนประจำ','คอนแวนต์','วิชาเอก','อาชีวศึกษา','หลักสูตร','วิชาการ','วิทยาเขต','ปีการศึกษา','ข้อสอบ','การบ้าน','ตำรา','ลูกเสือ','ครู','คะแนน','สอบ','โรงเรียน','นักเรียน','ศึกษาธิการ','อาจารย์','ลูกศิษย์','ชมรม','วิทยา','คณาจารย์','เล่าเรียน','วิชา','หน่วยกิต','มัธยมศึกษา','มัธยม','สหศึกษา','ประถม','อนุบาล','โรงเรียนสาธิต'],
        ...
        'ครอบครัว'   :['ครอบครัว','พ่อแม่','พ่อ','แม่','มารดา','ตระกูล','สืบเชื้อสาย','สายเลือด','เชื้อสาย','แม่ผัว','สะใภ้','พ่อตา','พี่น้อง','ลูกพี่ลูกน้อง','ญาติ','ทวด','ทายาท','หลาน','ลุง','ยาย','บุญธรรม','บุตรบุญธรรม',],
