...
def word_category():
    word_dict = {
        ...
        'การเรียน'   :['โรงเรียน',   'การเรียน','การศึกษา','มหาวิทยาลัย','เรียนต่อ','เรียนพิเศษ','ทุนการศึกษา','รายวิชา','ภาคเรียน','ความรู้','แนะแนว','พลศึกษา','เรียนรู้','เรียน','ครุ','วิชาเอก','อาชีวศึกษา','หลักสูตร','วิชาการ','วิทยาเขต','ปีการศึกษา','ข้อสอบ','การบ้าน','ทำการบ้าน','ตำรา','ลูกเสือ','ครู','คะแนน','ติว','สอบ','นักเรียน','ศึกษาธิการ','อาจารย์','ลูกศิษย์','ชมรม','วิทยา','คณาจารย์','เล่าเรียน','วิชา','หน่วยกิต','มัธยมศึกษา','มัธยม','มัธยมต้น','มัธยมปลาย','สหศึกษา','ประถม','อนุบาล','เทอม','เปิดเทอม','ปิดเทอม','ค่าเทอม','ผลการเรียน'],
